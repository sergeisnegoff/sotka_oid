                            ...
                            <table class="column" role="presentation" align="center" width="100%" cellspacing="0"
                                ...
                                <tr>
                                    <td class="column_cell px pt pb_md text_secondary text_link text_center"
                                        ...
                                        <p class="mb_xs"
                                           style="color: inherit;font-family: Arial, Helvetica, sans-serif;margin-top: 0px;margin-bottom: 8px;word-break: break-word;font-size: 16px;line-height: 26px;">{{ date('d', strtotime($order->created_at)) }} {{ rusDate(date('m', strtotime($order->created_at))) }} {{ date('Y', strtotime($order->created_at)) }}</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                        ...
                                        <p class="text_link"
                                           style="color: inherit;font-family: Arial, Helvetica, sans-serif;margin-top: 0px;margin-bottom: 0px;word-break: break-word;font-size: 16px;line-height: 26px;">
                                            @if (isset($address->city))
                                                Адрес доставки: <b>{{ $address->region }}, {{ $address->city }}, {{ $address->address }} {{ $address->house }}</b>
                                            @else
                                                Самовывоз
                                            @endif
                                        </p>
