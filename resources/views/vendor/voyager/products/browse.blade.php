...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('js/libs/jstree/themes/default/style.css') }}">

    <style>
        li:not(.jstree-leaf) > .jstree-icon.jstree-ocl:before {
            content: "\E092";
        }
        li:not(.jstree-leaf) > .jstree-icon.jstree-ocl {
            font-size: 18px;
