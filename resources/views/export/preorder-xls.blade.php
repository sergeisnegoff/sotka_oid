...
<table style="padding: 1.2mm 2mm">
    ...
    <tr>
        ...
        <td></td>
        <td></td>
        <td style="text-align: right" colspan="2">{{auth()->user()->name}}</td>
    </tr>
    <tr>
...
<table style="padding: 1mm 2mm">
    <tbody>
    <tr>
        <td style="border-bottom: {{$border}}">Всего наименований: {{ count($preorder->products) }}, на сумму {{ $preorder->total_amount }} руб.</td>
    </tr>
    </tbody>
</table>
